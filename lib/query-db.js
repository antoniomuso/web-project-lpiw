module.exports = {
    ...
    get_messages_of_chat (chat, intervalH) {
        return {
            ...
            text: "SELECT m.ist, m.utente , username, corpo FROM Messaggio m, Utente u WHERE m.chat = $1 AND m.ist > current_timestamp - interval '5 hours' AND m.utente = u.id ORDER BY m.ist",
            values: [chat]
        }
    }
}
